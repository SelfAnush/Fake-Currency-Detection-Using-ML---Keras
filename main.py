...
# import tesseract
import pytesseract
pytesseract.pytesseract.tesseract_cmd = 'C://Users//halid//AppData//Local//Tesseract-OCR//tesseract.exe'
...
app = Flask(__name__)
model2 = keras.models.load_model('final.h5')  # Lenet-aw.h5

autoencoder = keras.models.load_model('happyHack.h5')
...
def get():
	...
	with graph.as_default():
		model2 = keras.models.load_model('final.h5')
		...
		# json_file.close()
		# loaded_model = model_from_config(loaded_model_json)
		...
		# model2.call = tf.function(model2.call)
